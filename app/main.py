...
app=FastAPI(title='Productized AI Service Engine',version='0.5.0')
...
@app.get('/health')
def health(): return {'status':'ok','service':'productized-ai-service-engine','version':'0.5.0','payment_gate':True,'persistent_store':bool(os.getenv('DATABASE_URL')),'instant_fulfillment':True}
@app.get('/offer')
